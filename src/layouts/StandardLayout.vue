      ...
      <q-toolbar class="lmm-bar">
        ...
        <div class="gt-xs">
          ...
          <q-btn
            flat
            icon="history_edu"
            @click="trackDownload('methodology')"
    ...
    <q-footer>
      <div class="row q-col-gutter-lg logo-row">
        <div class="col-12 col-md-2">
          <a target="_blank" href="https://kof.ethz.ch"
            ><img src="kof-neg.png" height="25"
          /></a>
        </div>
        <div class="col-12 col-md-2">
          <a target="_blank" href="https://ethz.ch"
            ><img src="eth-neg.png" height="25"
          /></a>
        </div>
        <div class="col-12 col-md-2">
          <a
            target="_blank"
            href="https://www.snf.ch/en/hRMuYd5Qqjpl1goQ/page/researchinFocus/nrp/nrp77"
            ><img src="nfp_en.png" height="25"
          /></a>
        </div>
        <div class="col-12 col-md-2">
          <a target="_blank" href="https://www.snf.ch"
            ><img src="snf_en.svg" height="25"
          /></a>
        </div>
        <div class="col-12 col-md-2">
          <a target="_blank" href="https://unil.ch"
            ><img src="unil-neg.png" height="25"
          /></a>
        </div>
        <div class="col-12 col-md-2">
          <a target="_blank" href="https://x28.ch"
            ><img src="x28-neg.png" height="25"
          /></a>
        </div>
      </div>
      <hr />
      <div class="row q-col-gutter-lg">
        <div class="col-12 col-md-6">
          ...
          <b
            >{{ $t("footer.contact.kof") }} <br />
            {{ $t("footer.contact.ethz") }}</b
          >
          <br />
          {{ $t("footer.contact.division") }} <br />
          <br />
          <b>{{ $t("footer.contact.content_head") }}</b
          ><br />
